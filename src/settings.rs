...
pub struct Look {
	...
	pub message_height: f64,
	pub message_offset: Vec2f,
	pub thick_line_thickness: f64,
	pub thin_line_thickness: f64,	
	pub region_line_thickness: f64,
	...
	pub color_lines_edit: [f32; 4],
	pub color_lines_region: [f32; 4],
	pub color_overlay: [f32; 4],
	pub color_overlay_back: [f32; 4],
	pub color_message: [f32; 4],
}
...
impl Look {
    pub fn standard33() -> Look {
        Look {
			...
			overlay_offset: Vec2f{ x: 50.0, y: 100.0 },
			overlay_text_interval: 40.0,
			message_font_size: 12,
			message_height: 30.0,
			message_offset: Vec2f{ x: 20.0, y: -10.0 },
			thick_line_thickness: 6.0,
			thin_line_thickness: 2.0,
			region_line_thickness: 16.0,
			color_base: [1.0; 4],
